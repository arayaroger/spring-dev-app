package com.pfcti.spring.dev.app.ws;
...
public class TestClientEndpointSoap {
    ...
    public void testSendAndReceive() {
        ...
        GetClienteResponse response = (GetClienteResponse) ws.marshalSendAndReceive("http://localhost:"
                + port + "/ws", request);
        System.out.println("response :"+response.getCliente().toString());
        System.out.println("response :"+response.getCliente().getNombre()); assertThat(response != null);
